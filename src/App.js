...
const defaultTree = [
  {
    ...
    child: [
      { id: "02", child: [] },
      { id: "12", child: [{ id: "13", child: [{ id: "14", child: [] }] }] },
    ],
  },
...
function Node({ node, onAdd, onRemove }) {
  ...
  return (
    <div style={{ marginLeft: "70px", marginTop: "10px",position: 'relative', display: 'flex', flexDirection: 'column', left: 25, borderLeft: '1px solid', paddingLeft: 15  }}>
      <div className="Box">
